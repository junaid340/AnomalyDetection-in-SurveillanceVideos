# -*- coding: utf-8 -*-
"""
Created on Thu Apr  2 00:45:43 2020
...
def TrainModel(X_train, model, ckpt_name, hist_name, ckpt_path, epochs, batch_size):
    '''
    Just the function to start the training of the model.

    Parameters
    ----------
    X_train : 
      Training data, on which the model will train.
    model : 
      Pass the model architecture.
    ckpt_name : 
      Name for the trained model to be saved after training.
    hist_name : 
      Name for the history of the trained model.
    ckpt_path : 
      Path where to save the trained model.
    epochs : 
      Number of training epochs.
    batch_size : 
      Batch size to be passed to the model for training.

    Returns
    -------
      Returns the model history of training.
    '''
